...
public class ShiroDbRealm extends AuthorizingRealm {
    ...
    private AuthenticationToken authcTokenCurrrent;
    ...
    public void removeUserCache(ShiroUser shiroUser) {
        ...
        redoGetAuthenticationInfo(shiroUser.getLoginName());
    }
    ...
    public void removeUserCache(String loginName) {
        ...
        redoGetAuthenticationInfo(loginName);

    }


    protected AuthenticationInfo redoGetAuthenticationInfo(String loginName
